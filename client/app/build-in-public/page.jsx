...
export default function BuildInPublic() {
  ...
  const [userId, setUserId] = useState(null); // optional: if backend exposes user id in localStorage
  ...
  async function handleComposeSubmit() {
    if (!token) return toast.error("Please login or sign up to continue!");
